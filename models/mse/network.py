...
class GANLung(BaseModel):
    ...
    def backward_g(self, input, fake, latent_i, latent_o):
        ...
        return err_g, err_g_con, err_g_adv, err_g_enc
    ...
    def optimize_params(self, input):
        ...
        err_g, err_g_con, err_g_adv, err_g_enc = self.backward_g(input, fake, latent_i, latent_o)
        ...
        return err_g, err_d, err_g_con, err_g_adv, err_g_enc
