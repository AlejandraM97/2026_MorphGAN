...
from models.mse.network import GANLung
...
def train(opt, train_loader: DataLoader, test_loader: DataLoader) -> None:
    ...
    for epoch in range(opt.epochs):
        epoch_g_loss, epoch_d_loss, epoch_g_con_loss, epoch_g_adv_loss, epoch_g_enc_loss = 0, 0, 0, 0, 0  # Track total loss for the epoch
