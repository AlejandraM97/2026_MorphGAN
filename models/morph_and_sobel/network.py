...
from utils.losses import l2_loss, l2_z_loss, ssim_loss, combined_loss, MorphologicalLoss, CombinedSpatialLoss
...
class GANLung(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.CombinedLoss = CombinedSpatialLoss(morph_weight=0.5, sobel_weight=0.5)
