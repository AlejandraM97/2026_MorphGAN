...
from utils.losses import l2_loss, l2_z_loss, ssim_loss, combined_loss, MorphologicalLoss, SummedSpatialLoss, MultipliedSpatialLossNormalized
...
class GANLung(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.CombinedLoss = MultipliedSpatialLossNormalized()
