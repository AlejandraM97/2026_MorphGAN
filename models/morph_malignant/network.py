...
from utils.losses import l2_loss, l2_z_loss, ssim_loss, combined_loss, MorphologicalPixelLoss, MorphologicalLoss
...
class GANLung(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.MorphologicalLoss = MorphologicalPixelLoss()
        # self.MorphologicalLoss = MorphologicalLoss()
        ...
        # For transfer learning, use the learning rate a lil bit lower
        # self.optimizer_G = optim.Adam(self.generator.parameters(), lr=0.00002, betas=(0.5, 0.999))
    ...
    def backward_g(self, input, fake, latent_i, latent_o):
        ...
        err_g_con = self.MorphologicalLoss(fake, input)
        ...
        # print(f'I\'m backpropagating through Generator. The input shape is {input.shape}, the fake shape is {fake.shape}, and the latent shapes are {latent_i.shape} and {latent_o.shape}.')
