...
from utils.losses import l2_loss, l2_z_loss, ssim_loss, combined_loss
...
class GANLung(BaseModel):
    ...
    def backward_g(self, input, fake, latent_i, latent_o):
        ...
        return err_g, err_g_con, err_g_adv, mmd
    ...
    def optimize_params(self, input):
        ...
        err_g, err_g_con, err_g_adv, mmd = self.backward_g(input, fake, latent_i, latent_o)
        ...
        return err_g, err_d, err_g_con, err_g_adv, mmd
